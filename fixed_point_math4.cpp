...
See here: https://stackoverflow.com/a/3206195/4561887. 
    cp fixed_point_math4.cpp fixed_point_math4_copy.c && gcc -Wall -o fixed_point_math4_c fixed_point_math4_copy.c && ./fixed_point_math4_c
As a C++ program:
    g++ -Wall -o fixed_point_math4_cpp fixed_point_math4.cpp && ./fixed_point_math4_cpp
...
int main(int argc, char * argv[])
{
    ...
    const uint32_t PRICE_ORIGINAL = 501;
    uint32_t price = PRICE_ORIGINAL << FRACTION_BITS;
